class Person:
    ...
    def set_age(self, age):
        self.__age = age  # This actually stores value while the same line above just initialised
    ...
    # If want to use the initalised variables, need to use "self" in the sub-functions:
